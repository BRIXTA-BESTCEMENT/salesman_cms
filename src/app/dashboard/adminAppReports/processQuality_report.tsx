        ...
        const fetchReport = async () => {
            try {
                ...
                const endpoint = isLatest 
                    ? `/api/dashboardPagesAPI/admin-app-reports/process-quality?action=latest`
                    : `/api/dashboardPagesAPI/admin-app-reports/process-quality?${params.toString()}`;
                ...
                if (result.success && result.data) {
                    ...
                    if (fetchedData) {
                        ...
                        setError("No Process report found for the selected dates.");
                        setData(null);
                    }
                } else {
                    setError("No Process report found.");
                    setData(null);
                }
            } catch (err) { 
